...
To test the user input, we use the unittest.mock.patch context manager to mock the input function. In this test, the input function will return the values stored in self.username, self.password, and self.email when called.
"""
