...
class TestCustomerFilterAPIView(AuthTestCase):

    def test_customer_filter_view(self):
        response = self.client.get('/api/scheduling/customers?start__lt=2025-12-28', **self.headers)
