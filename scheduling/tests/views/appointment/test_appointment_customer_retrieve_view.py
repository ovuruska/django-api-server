...
class TestAppointmentCustomerRetrieveAPIView(AuthTestCase):

        def test_appointment_customer_retrieve_view(self):

            # Retrieve
            response = self.client.get(
                f'/api/appointment/{self.appointment.customer.id}',
                **self.headers
            )
