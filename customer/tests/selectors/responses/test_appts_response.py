...
class Appointment(BaseModel):
	...
	customer = models.ForeignKey("Customer", on_delete=models.CASCADE, related_name="appointments", blank=False)
	...
	employee = models.ForeignKey("Employee", on_delete=models.CASCADE, related_name="appointments", blank=True, null=True)
